...
public class Main {
    ...
    public static void juegoDePruebaMedicos(Sistema s, Prueba p) {
        ...
        p.ver(s.listarMédicos().resultado, Retorno.Resultado.OK, "Se crea lista de medicos exitosamente");
        ...
        System.out.println("====================  Se Muestra Lista Medicos  ========================");
        s._medicos.mostrar();
        System.out.println("====================   Se Agregar Medico Pepe al Inicio   =======================");
        s._medicos.agregarInicio(medicoUno);
        System.out.println("====================   Se Agregar Medico Carlos al Final   =======================");
        s._medicos.agregarFinal(medicoDos);
        System.out.println("====================   Se Listan Los Medicos   ========================");
        p.ver(s.listarMédicos().resultado, Retorno.Resultado.OK, "Se crea lista de medicos exitosamente");
    }
    ...
    public static void juegoDePruebaPacientes(Sistema s, Prueba p) {
        ...
        p.ver(s.listarPacientes().resultado, Retorno.Resultado.OK, "Lista de pacientes creada exitosamente");
        ...
        System.out.println("====================  Se Muestra Lista Pacientes  ========================");
        s._pacientes.mostrar();
        ...
        System.out.println("====================  Se Muestra Lista Pacientes  ========================");
        s._pacientes.mostrar();
        System.out.println("====================   Agregar Paciente Zonar Inicio   =======================");
        s._pacientes.agregarInicio(pacienteUno);
        System.out.println("====================   Agregar Paciente Gaston Final   =======================");
        s._pacientes.agregarFinal(pacienteDos);
        System.out.println("====================   Se Listan Los Pacientes   ========================");
        p.ver(s.listarPacientes().resultado, Retorno.Resultado.OK, "Lista de pacientes creada exitosamente");
    }
