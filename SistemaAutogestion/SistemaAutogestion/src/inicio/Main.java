...
public class Main {
    ...
    public static void juegoDePruebaAnunciarLlegadaAlTotem(Sistema s, Prueba p) {
        ...
        p.ver(s.anunciaLlegada(150, 47492203).resultado, Retorno.Resultado.OK, "Existe una consulta para ese conjunto");
        p.ver(s.anunciaLlegada(150, 28785574).resultado, Retorno.Resultado.OK, "Existe una consulta para ese conjunto");        
        p.ver(s.anunciaLlegada(152, 47292203).resultado, Retorno.Resultado.OK, "Existe una consulta para ese conjunto");
        p.ver(s.anunciaLlegada(999, 47192203).resultado, Retorno.Resultado.OK, "Existe una consulta para ese conjunto");
        p.ver(s.anunciaLlegada(150, 28785574).resultado, Retorno.Resultado.OK, "Existe una consulta para ese conjunto");
    }
    ...
    public static void juegoDePruebaTerminarConsultaMedicoPaciente(Sistema s, Prueba p) {
        ...
        p.ver(s.terminarConsultaMedicoPaciente(41238000, 820, "El paciente sufre de risa cronica").resultado, Retorno.Resultado.ERROR_1, "No existe Paciente");
